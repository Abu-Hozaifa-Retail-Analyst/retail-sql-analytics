...
| 2 | RFM Segmentation *(coming soon)* | Which customers are most valuable, and which are at risk of churning? | `NTILE()`, `CASE`, window functions | — |
| 3 | Market Basket Analysis *(coming soon)* | Which products are commonly bought together? | Self-joins, aggregation | — |
